...
# Following Fan et al., 2019, we excluded CpG sites (i) that were measured in less than ~57 individuals, (ii) where methylation levels fell below 10% or above 90% in at least 90% of measured individuals, 
#(iii) that had a mean read depth less than 5, or (iv) that were paired with a SNP with MAF < 0.05 across individuals for whom DNA methylation estimates were available
